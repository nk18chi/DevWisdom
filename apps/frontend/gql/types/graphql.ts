  ...
  users?: {
    ...
    edges?: Array<{
      ...
      node?: {
        ...
        _id: string;
        name: string;
        followers?: Array<{ __typename?: 'User'; _id: string; name: string } | null> | null;
        following?: Array<{ __typename?: 'User'; _id: string; name: string } | null> | null;
      } | null;
    } | null> | null;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        kind: 'SelectionSet',
        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'userToken' } }],
      },
    },
  ],
